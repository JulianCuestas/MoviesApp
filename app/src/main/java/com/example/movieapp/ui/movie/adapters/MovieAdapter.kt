...
class MovieAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): BaseViewHolder<*> {
        ...
        itemBinding.root.setOnClickListener {//obtiene y hace clickeable a toda la película completa
    ...
    private inner class MoviesViewHolder( // Inner garantiza para que el obj muera cuando muera su clase padre
